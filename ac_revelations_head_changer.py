...
class Head:
    ...
    def __init__(self, folder):
        ...
        self.specular = HexFile()
        self.specular.kind = FileKind.specular.value
        ...
        self.load_file_info(hex_file=self.specular)
...
class HeadChanger:
    ...
    def report_id(head_number: str, head_obj: Head):
        ...
        print(f'Specular: {head_obj.specular.hex_id}')
    ...
    def change_ids(self):
        self.change_id(original_hex_file=self.head2.specular, new_hex_file=self.head1.specular)
